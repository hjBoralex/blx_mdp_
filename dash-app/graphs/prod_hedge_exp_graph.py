...
annotations_y = [dict(
            ...
            align='center', 
            font=dict(size=8),
        ) for xi, yi, zi in zip(years['years'], query_results_10['prod_per_year'], query_results_7['hcr_per_year'])]
...
annotations_q = [dict(
            ...
            align='center', 
            font=dict(size=8),
        ) for xi, yi, zi in zip(quarters['quarters'], query_results_11['prod_per_quarter'], query_results_8['hcr_per_quarter'])]
...
annotations_m = [dict(
            ...
            align='center', 
            font=dict(size=8),
        ) for xi, yi, zi in zip(months['months'], query_results_12['prod_per_month'], query_results_9['hcr_per_month'])]
    ...
    dcc.Graph(id='hedge_type_y',
               figure = {'data':[
                   ...
                   go.Bar(
                       ...
                       opacity=0.4,
                       base=query_results_4.loc[query_results_4['type_contract'] == 'PPA', 'hedge'],
                   ...
                   go.Bar(
                       ...
                       opacity=0.25,
                       base=query_results_4.loc[query_results_4['type_contract'] == 'OA', 'hedge'],
              ...
              figure = {'data':[
                 ...
                 go.Bar(
                  ...
                  go.Bar(
                      ...
                      opacity=0.4,
                      base=query_results_5.loc[query_results_5['type_contract']=='PPA', 'hedge'],
                      marker=dict(color=colors['oa']),
                      marker_line=dict(width= BAR_H_WIDTH, color=colors['bar_h_color'])
                      ),
                  go.Bar(
                      ...
                      opacity=0.25,
                      base=query_results_5.loc[query_results_5['type_contract']=='OA', 'hedge'],
                      marker=dict(color=colors['cr']),
                      marker_line=dict(width= BAR_H_WIDTH, color=colors['bar_h_color'])
                      ),
    ...
    dcc.Graph(id='hedge_type_m',
              figure = {'data':[
                  ...
                  go.Bar(
                      ...
                      opacity=0.4,
                      base=query_results_6.loc[query_results_6['type_contract'] == 'PPA', 'hedge'],
                      marker=dict(color=colors['oa']),
                      marker_line=dict(width= BAR_H_WIDTH, color=colors['bar_h_color'])
                      ),
                  go.Bar(
                      ...
                      opacity=0.25,
                      base=query_results_6.loc[query_results_6['type_contract'] == 'OA', 'hedge'],
                      marker=dict(color=colors['cr']),
                      marker_line=dict(width= BAR_H_WIDTH, color=colors['bar_h_color'])
                      ), 
                  go.Bar(
